            ...
            switch (num) {
                case 1: {
                    ...
                    if (userFirstChoice == 11) {
                        player1.house.houseCapacity -= 3;
                        player1.house.CapacityCheck();
                    }
                    if (userFirstChoice == 12) {
                        player1.house.houseCapacity -= 2;
                        player1.house.CapacityCheck();
                    }
                    if (userFirstChoice == 13) {
                        player1.house.houseCapacity -= 1;
                        player1.house.CapacityCheck();
                    }
                    if (userFirstChoice == 21) {
                        player1.land.numberOfPlants -= 1;
                        player1.land.NumberOfPlantsCheck();
                    }
                ...
                case 2: {
                    ...
                    if (userSecondChoice == 31) {

                    }
                    if (userSecondChoice == 32) {

                    }
                    if (userSecondChoice == 33) {
